"""
Message handlers - forwards owner messages to agent-core via HTTP and echoes the response.
"""
...
async def handle_owner_message(message: types.Message) -> None:
    ...
    try:
        ...
        await message.answer(f"Could not reach agent-core: {exc}")